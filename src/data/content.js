export const heroContent = {
  ...
  tagline: "Startup founder & builder turning ideas into products",
  description: "Founded Blur, a social platform with 2,000+ users. Building scalable products at Samsung, Forbes, and beyond.",
};
...
export const aboutContent = {
  ...
  stats: [
    ...
    { label: "Users Reached", value: "1.8 Million+" },
    { label: "Technologies", value: "20+" },
    { label: "Startup Founded", value: "2" },
  ],
};
